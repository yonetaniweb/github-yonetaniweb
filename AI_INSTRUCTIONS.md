...
| **40** | **Archives** | 倉庫 | 完了したプロジェクトの保管場所。QA対象外。 |
...
現在の作業プロジェクトに応じて、必ず以下の「一時置き場」に保存すること。
...
新規プロジェクトを作成する際は、**必ず以下のフローを自動実行すること。**
...
商品カタログ　https://XXXX.com/hobby/index.html
取扱商品　　　https://XXXX.com/hobby/products.html
季節商品　　　https://XXXX.com/hobby/season.html
